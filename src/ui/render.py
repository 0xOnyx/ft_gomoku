...
# Example game state
game_state_interactive_player_info = np.zeros((19, 19))

# Plot the interactive board with player move info
plot_gomoku_board_interactive_with_player_info(game_state_interactive_player_info)

# Plot the interactive board with win checking
# Example game state
game_state_interactive = np.zeros((19, 19))
game_state_interactive[1, 1] = -1  # Black piece at top-left
game_state_interactive[3, 3] = 1 # White piece at bottom-right
# Plot the interactive board
plot_gomoku_board_interactive_with_player_info(game_state_interactive)